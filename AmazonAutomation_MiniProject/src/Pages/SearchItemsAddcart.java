...
public class SearchItemsAddcart extends Action_Methods {
	...
	/*
	 * @FindBy(xpath="//*[@id='issDiv4']") public WebElement Androidcharger;
	 */
	...
	public void FindItem() throws InterruptedException {
		...
		try {
			int i = 1;
			List<WebElement> WebElement = driver.findElements(By.xpath("//div[@class='a-section a-spacing-medium']"));
			int count = WebElement.size();
			for (WebElement element : WebElement) {
				String text = driver.findElement(By.xpath(
						"(//div[@class='a-section a-spacing-medium']//span[1][@class='a-price']//span[@class='a-price-whole'])["
								+ i + "]"))
						.getText();
				...
				if (number >= 500) {
					...
					String product = driver.findElement(By.xpath(
							"(//div[@class='a-section a-spacing-medium']//span[@class='a-size-base-plus a-color-base a-text-normal'])["
									+ i + "]"))
							.getText();
	...
	public void logout() {
		...
		WebElement menuitem = driver.findElement(By.xpath("//*[@id='nav-link-accountList']/span[2]"));
